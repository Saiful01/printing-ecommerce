                    ...
                    <div class="dropdown-menu dropdown-menu-lg" id="search-dropdown">
                        <div data-simplebar style="max-height: 320px;">
                            ...
                            <div class="dropdown-item bg-transparent text-wrap">
                                <a href="/admin/dashboard" class="btn btn-soft-secondary btn-sm btn-rounded">how to
                                    setup <i
                                        class="mdi mdi-magnify ms-1"></i></a>
                                <a href="/admin/dashboard" class="btn btn-soft-secondary btn-sm btn-rounded">buttons
                                    <i
                                        class="mdi mdi-magnify ms-1"></i></a>
                            </div>
                            <!-- item-->
                                ...
                                <div data-simplebar style="max-height: 300px;" class="pe-2">
                                 ...
                                 --}}{{--   @foreach($leave_list as $item)
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-1">
                                                    <a href="#" class="stretched-link">
                                                        <h6 class="mt-0 mb-2 lh-base">{{$item->name}} Requested for {{ $item->holiday_count }}  days leave</h6>
                                                    </a>
                                    ...
                                    <div class="my-3 text-center">
                                        <a href="/leave/show" class="btn btn-soft-success waves-effect waves-light">
                                            View All Leave Request <i class="ri-arrow-right-line align-middle"></i>
                                        </a>
                                    </div>
                                </div>
