<html lang="en">
    <head>
        <title>Laravel 8 Stripe Payment Gateway</title>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <form  action="{{url('payment')}}"  data-cc-on-file="false" data-stripe-publishable-key="pk_test_51M009nCHxrrecZpaLe9gjwv3cWQi7hiCON2ojB6LkIhD5LYl9HnYNZmRNnlH9VkUf6Aj9UljwoYgfpNhdCAhvgpl00g1iqBtJ9" name="frmStripe" id="frmstripe" method="post">
                        {{ csrf_field() }}
                        <div class="row">
