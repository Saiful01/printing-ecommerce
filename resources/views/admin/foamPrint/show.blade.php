        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">Foam Board Size And Prices


                        <a type="button" href="/admin/foam-board/price" class="btn btn-success add-btn"><i
                        ...
                        <div class="table-responsive table-card mt-3 mb-1">
                            <table class="table align-middle table-nowrap" id="data-table">
                                ...
                                <tr>
                                    ...
                                    <th class="sort" data-sort="Country">Foam Board Size</th>
