...
@section('title', 'Edit Custom Print Size Price')
                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Edit Size Price</li>
                        </ol>
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="live-preview">
                            <form action="/admin/custom/price/update" method="post"
                                  enctype="multipart/form-data">
                                <div class="row gy-4">
                                    <div class="col-xxl-2 col-md-2 col-6">
                                        <div>
                                            <label for="placeholderInput" class="form-label">Min Size</label>
                                            <input type="text" class="form-control" value="{{$results->min}}" name="min" id="min"
                                    ...
                                    <div class="col-xxl-2 col-md-2 col-6">
                                        <div>
                                            ...
                                            <input type="text" class="form-control" value="{{$results->max}}" name="max" id="max"
