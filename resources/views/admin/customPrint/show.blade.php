...
@section('title', 'Custom Print Price Details')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Custom Price</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="/admin/dashboard">Dashboards</a></li>
                        <li class="breadcrumb-item active">Custom Price Details</li>
                    </ol>
                </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">Custom Size And Prices


                        <a type="button" href="/admin/custom/price" class="btn btn-success add-btn"><i
                            ...
                            <table class="table align-middle table-nowrap" id="data-table">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th class="sort" data-sort="Country">Min Size</th>
                                        <th class="sort" data-sort="Country">Max Size</th>
                                ...
                                <tbody class="list form-check-all">
                                    ...
                                    @foreach($results as $item)
                                        <tr>
                                            <td class="institute">{{$item->min}}</td>
                                            <td class="institute">{{$item->max}}</td>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    <div class="edit">
                                                        <a href="/admin/custom/price/edit/{{$item->id}}" class="btn btn-sm btn-info edit-item-btn">
                                                            Edit
                                                        </a>
                                                    </div>
                                                    <div class="remove">
