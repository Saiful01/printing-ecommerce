...
@section('title', 'Show Shipping List')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Shipping List</h4>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">Shipping List


                        <a type="button" href="/admin/shipping/add" class="btn btn-success add-btn"><i
                            ...
                            <table class="table align-middle table-nowrap" id="data-table">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th class="sort" data-sort="Country">Shipping Title</th>
                                        <th class="sort" data-sort="Country">Shipping Price</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    <div class="edit">
                                                        <a href="/admin/shipping/edit/{{$item->id}}" class="btn btn-sm btn-info edit-item-btn">
                                                            Edit
                                                        </a>
                                                    </div>
                                                    <div class="remove">
                                                        <a href="/admin/shipping/delete/{{$item->id}}" onclick="return confirm('Are you sure you want to delete?');" class="btn btn-sm btn-danger remove-item-btn">
                                                            Remove
                                                        </a>
                                                    </div>
                                                </div>
