...
@section('title', 'Add Shipping Price')
                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Shipping Price Add</li>
                        </ol>
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="live-preview">
                            <form action="/admin/shipping/store" method="post"
                                ...
                                <div class="row gy-4">
                                    ...
                                    <div class="col-xxl-4 col-md-4 col-8">
                                        <div>
                                            ...
                                            <div class="form-icon">
                                                <input type="text" class="form-control form-control-icon" name="Shipping_charge" id="Shipping_charge" placeholder="40">
